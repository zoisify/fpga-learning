...
reconfigurable computing (2027 entry) and a hardware engineering career. This repo
tracks that journey in public: every project, mistake and revision.
...
| 02 | Traffic light FSM | Finite state machines, timed transitions |
| 03 | UART | Serial protocols, baud generation, RX/TX |
| 04 | FIFO | Dual-clock thinking, full/empty flags, pointers |
...
| 09 | FFT | Pipelined fixed-point DSP, precision-vs-resource analysis |
| 10 | HLS MNIST | High-level synthesis, quantised neural network inference |
